...
public class UIManager : MonoBehaviour
{
    ...
    public Slider respuestaA, respuestaB, respuestaC;
    ...
    public void SubmitForm()
{
    ...
    public void ShowSurvey(System.Action<int, int, int> onComplete)
    {
        ...
        surveyPanel.GetComponentInChildren<Button>().onClick.AddListener(() =>
        {
            ...
            onComplete((int)respuestaA.value, (int)respuestaB.value, (int)respuestaC.value);
        });
    }
